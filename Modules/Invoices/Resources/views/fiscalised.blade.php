...
@section('styles')
@endsection
@section('title','Fiscalised Invocies')
@section('content')
    <!-- PAGE HEADER -->
        ...
        <div class="row align-items-center">
          <div class="col-md-12">
            <div class="page-header-title">
              <h4 class="m-b-10">{{ __('All Quickbooks Fiscalised Invoices') }}</h4>
            </div>
            <ul class="breadcrumb">
              <li class="breadcrumb-item "><a href="{{ route('home') }}">{{ __('Dashboard') }}</a></li>
              <li class="breadcrumb-item">{{ __('Quickbooks') }}</li>
              <li class="breadcrumb-item active">{{ __('Fiscalised Invoice') }}</li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">All Fiscalised Invoices</h3>
                </div>
                <div class="card-body">
