...
class SettingsController extends \App\Http\Controllers\Controller
{
  ...
  public function qboSettingUpdate(Request $request)
  {
    $this->validate($request, [
      'client_key' => 'required',
      'client_id' => 'required',
      ...
      'client_key.regex' => 'Invalid Entry! The stripe key only letters, underscore and numbers are allowed',
      'client_id.regex' => 'Invalid Entry! The stripe secret only letters, underscore and numbers are allowed',
    ]);
    $data = [
      ...
      'CLIENT_SECRETE' => $request->client_key,
      'CLIENT_ID' => $request->client_id,
      'BASE_URL' => $request->qbo_base_url,
      'BASE_DEV' => $request->environment,
      'QBOREALMID' => $request->qborealm_id,
      'INUIT_COMPANY_ID' => $request->company_id,
  ...
  public function authSettingsUpdate(Request $request)
  {
    if (Auth::user()->type == 'Super Admin') {
      $data = [
        ...
        'stock_adjust_keyword' => $request->stock_adjust_keyword,
        'is_deemed_registered' => $request->is_deemed_registered,
