...
<body>
    ...
    <header>
        <div class="w-50 float-left mt-10">
            ...
            <h1 class="text-center m-0 p-0">Fiscal Credit Note</h1>
        </div>
        <div class="w-50 float-left logo mt-10">
            <img src="{{ $regDetails->data->sellersLogo }}" width="80" height="80" />
        </div>
    ...
    <header>
        ...
        <div class="w-50 float-left logo mt-10">
            <p>
                <b>CCN</b>: <span class="text-xs font-thin"> {{ $doc->data->basicInformation->invoiceNo }}</span><br>
                <b>Verification Code</b>: <span
                    class="text-xs font-thin">{{ $doc->data->basicInformation->antifakeCode }}</span><br>
                <b>Issue Date</b>: <span
                    class="text-xs font-thin">{{ $doc->data->basicInformation->issuedDate }}</span><br>
    ...
    <div class="company" style="">
        <div id="company">
            <p>
                ...
                @if ($doc->data->buyerDetails->buyerType !== '1')
    ...
    <div class="table-section bill-tbl w-100 mt-10">
        <h3 class="table-title">CreditNote Summary</h3>
        <table class="table w-100 mt-10">
    ...
    <div id="notices">
        ...
        <p style="text-align: center">
            <img src="{{ $doc->data->summary->qrCode }}" />
        </p>
    </div>
</body>
